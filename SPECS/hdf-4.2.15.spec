...
Patch0: hdf-maxavailfiles.patch
Patch1: hdf-ppc.patch
Patch2: hdf-sparc.patch
...
--with-jpeg=/usr LDFLAGS="-L/usr/lib64/mpich/lib/ -L/usr/lib64/openmpi/lib/" LD_LIBRARY_PATH="/usr/lib64/openmpi/lib/ /usr/lib/gcc/x86_64-redhat-linux/4.8.5/32/"
...
%changelog
* Mon Jul 13 2020 Ketan Patel <patelkr@ornl.gov> 4.2.15-1
- Update to 4.2.15
