...
cmake3 -DINSTALL_LIB_DIR=%{_libdir} \
      ...
      -DWITH_EXEMPI=FALSE \
      -Wno-dev \
      -DPYTHON_LIBRARIES=/usr/lib64/libpython3.so \
      -DPYTHON_INCLUDE_PATH=/usr/include/python3.6m \
      -DPYTHON_EXECUTABLE=/usr/bin/python3 \
      -DPY_SETUPTOOLS=/usr/lib/python3.6/site-packages/setuptools \
      ..
