...
#       --no-sign --packager patelkr@ornl.gov Geo::IP::PurePerl
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname Geo-IP-PurePerl
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    http://search.cpan.org//CPAN/authors/id/B/BO/BORISZ/Geo-IP-PurePerl-1.25.tar.gz
...
%{__perl} -MFile::Find -le '
    ...
    print "%doc  Changes INSTALL README";
...
%changelog
* Tue Mar 10 2015 lrknox@k2patelrad.ornl.gov
- Initial build.