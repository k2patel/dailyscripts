...
#       --no-sign http://search.cpan.org/CPAN/authors/id/D/DH/DHUNT/PDL-NetCDF-4.20.tar.gz --version 4.20
...
buildarch: x86_64
prefix:    %(echo %{_prefix})
source:    http://search.cpan.org/CPAN/authors/id/D/DH/DHUNT/PDL-NetCDF-4.20.tar.gz
