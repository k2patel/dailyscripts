...
#       --no-sign --author 'Tim Jenness' --version 0.03 http://search.cpan.org/CPAN/authors/id/T/TJ/TJENNESS/Graphics-PLplot-0.03.tar.gz
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname Graphics-PLplot
...
buildarch: x86_64
prefix:    %(echo %{_prefix})
source:    http://search.cpan.org/CPAN/authors/id/T/TJ/TJENNESS/Graphics-PLplot-0.03.tar.gz
Patch0:    Graphics-PLplot.patch
...
%patch0 -p0 -b Graphics-PLplot.patch
