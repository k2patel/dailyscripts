...
#       HTML::TreeBuilder::XPath --no-sign
#   For more information on cpan2rpm please visit: http://perl.arix.com/
#

%define pkgname HTML-TreeBuilder-XPath
...
version:   0.14
release:   1
vendor:    Michel Rodriguez <mrodrigu@localdomain>
...
buildarch: noarch
prefix:    %(echo %{_prefix})
source:    HTML-TreeBuilder-XPath-0.14.tar.gz
...
%changelog
* Mon Sep 28 2015 lrknox@k2patelrad.ornl.gov
- Initial build.